        ...
        <nav className='bg-white w-full border-b-2'>
            <div className='flex justify-between items-center max-w-7xl mx-auto py-6 px-3'>
                ...
                <Link href={PLAY_STORE_LINK} passHref legacyBehavior>
                    <a target="_blank" className='bg-green p-2 sm:px-4 sm:p-3 rounded-full text-white sm:text-lg text-base text-center flex items-center gap-1 shadow hover:shadow-md transition-all'>
