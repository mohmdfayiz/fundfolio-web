    ...
    <section className="mx-auto my-auto px-3 py-10">
      <div className="bg-white rounded-3xl flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto">
        <div className="flex flex-col gap-3 p-12 sm:p-16">
          ...
          <Link href={PLAY_STORE_LINK} passHref legacyBehavior>
            <a target="_blank" className='bg-green px-4 py-2 sm:py-3 rounded-full w-36 text-white sm:text-lg text-base text-center flex items-center gap-1 shadow hover:shadow-md transition-all'>
              Download
